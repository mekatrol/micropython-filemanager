...
export const renderConnectHtml = (rows: ConnectRow[], connectAttemptTimeoutMs: number): string => {
...
<head>
  ...
  <style>
    ...
    .table-section + .table-section { margin-top: 16px; }
    ...
    th.unconnectedPort, td.unconnectedPort { width: 220px; }
    th.unconnectedStatus, td.unconnectedStatus { width: auto; }
...
<body>
  <div class="wrap">
    ...
    <div class="table-section">
      ...
      <table>
        <thead>
          <tr>
            <th class="unconnectedPort">Serial Port</th>
            <th class="unconnectedStatus">Status</th>
          </tr>
        </thead>
        <tbody id="unconnectedRows"></tbody>
      </table>
    </div>
    <div class="table-section">
      <h3 class="table-title">Connected serial ports</h3>
      <table>
        <thead>
          <tr>
  ...
  <div id="probeModal" class="probe-modal hidden" role="dialog" aria-modal="true" aria-label="Probe devices status">
    <div class="probe-dialog">
      <h3 id="probeTitle" class="probe-title">Probing devices</h3>
  ...
  <script>
    ...
    const connectTimeoutMs = ${connectAttemptTimeoutMs};
